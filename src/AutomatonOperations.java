...
public class AutomatonOperations {
    ...
    public static Automaton convertToDFA(Automaton nfa) {
        ...
        while (!statesToProcess.isEmpty()) {
            ...
            System.out
                    .println("Adding transition from DFA state " + currentDFAState + " to DFA state " + newStateDFAId);
        }
    ...
    public static Automaton minimizeDFA(Automaton dfa) {
        ...
        System.out
                .println("Initial partitions: Accepting=" + acceptingStates + ", Non-accepting=" + nonAcceptingStates);
